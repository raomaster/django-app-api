...
class PublicUserAPITest(TestCase):
    ...
    def test_create_token_for_user(self):
        """Testing that a token is created for the user"""
        payload = {
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@example.com', password='testpass1')
    ...
    def test_create_token_no_user(self):
        """Test that the tpken is not created if user doesn't exist"""
...
class PriveteUserAPITests(TestCase):
    """Test API requests that rquire authentication"""

    def setUp(self):
        """For al test we create a user an force authentication"""
