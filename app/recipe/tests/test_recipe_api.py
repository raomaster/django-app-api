...
def image_ipload_url(recipe_id):
...
class PrivateRecipeAPITest(TestCase):
    ...
    def testrecipes_limited_to_user(self):
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_upload_image_url(self):
        ...
        url = image_ipload_url(self.recipe.id)
    ...
    def test_upload_image_bad_request(self):
        """Test for an bad Request to save recipe with image"""
        url = image_ipload_url(self.recipe.id)
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Fish and cheese')
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes specific ingredients"""
